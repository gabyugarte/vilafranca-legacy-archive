export const history = {
  title: "Historia del Barrio Vilafranca",

  subtitle:
    "La historia del Barrio Vilafranca es la historia de cientos de personas que, durante décadas, han servido, aprendido y fortalecido su fe en Jesucristo. Cada generación ha dejado una huella que merece ser recordada.",

  quote: {
    text: "Y esto lo escribimos para que sepan las generaciones venideras...",
    reference: "Salmos 78",
  },
  ...
  chapters: [
    {
      ...
      subtitle: "Los comienzos de una historia de fe",

      image: "/images/history/capitulo1.jpg",
...
`,
        ...
        {
          title: "El nacimiento de la Rama Vilafranca",
...
`,
        ...
        {
          title: "La organización de la Primaria",
...
`,
    ...
    },
    {
      ...
      subtitle: "Un período de crecimiento y grandes bendiciones (2015–2019)",

      image: "/images/history/capitulo2.jpeg",
      ...
      sections: [
    {
  title: "La obra de Historia Familiar",
...
{
  title: "9 de junio de 2019 — Dedicación de la nueva capilla",
