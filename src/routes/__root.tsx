    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-3 font-display text-2xl text-foreground">
          Esta página aún no forma parte del archivo
        </h1>
        <p className="mt-3 text-sm text-muted-foreground">
          Es posible que la historia que buscas todavía no se haya escrito. Vuelve al inicio
          para seguir explorando el legado del barrio.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Ha ocurrido un problema al recuperar la historia. Puedes reintentarlo o volver al inicio.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Historia del Barrio Vilafranca — Museo digital" },
      {
        name: "description",
        content:
          "Museo digital que preserva la historia, la fe y el legado del Barrio Vilafranca de La Iglesia de Jesucristo de los Santos de los Últimos Días.",
      },
      { name: "author", content: "Barrio Vilafranca" },
      {
        property: "og:title",
        content: "Historia del Barrio Vilafranca — Museo digital",
      },
      {
        property: "og:description",
        content:
          "Preservamos la historia espiritual y humana del Barrio Vilafranca para las generaciones futuras.",
      },
